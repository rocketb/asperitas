...
// Set sets the metrics value into the context.
func Set(ctx context.Context) context.Context {
	return context.WithValue(ctx, key, m)
}

// AddGoroutines adds goroutines metric every 100 requests.
...
// AddRequest adds requests to the requests metric.
...
// AddErrors increments errors metric.
...
// AddPanics increments panics metric.
